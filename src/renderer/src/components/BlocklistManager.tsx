...
const BlocklistManager = forwardRef<BlocklistManagerHandle>(
  function BlocklistManager(_props, ref): React.JSX.Element {
      ...
      <>
        <div className="p-6">
          <div className="mb-4 flex items-baseline justify-between gap-4">
            ...
            {entries.length > 0 && (
              <span className="shrink-0 text-xs text-text-tertiary">{entries.length} Einträge</span>
            )}
          </div>
